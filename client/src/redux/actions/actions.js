...
export const getAllRecipes = (query) => {
  return function (dispatch) {
    return axios
      .get(`http://localhost:3001/recipes${query ? `?title=${query}` : ""}`) //en el axios no tengo q pasarlo a json,
...
export const filterRecipesAZ = (option) => {
  //si ejecuto la func con 1 me va a hacer de a-z y si lo hago con 2 me hace de z-a, y si lo hago con 3 me va a ordenar por health
  return function (dispatch) {
